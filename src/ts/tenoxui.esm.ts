...
export function addType(Types: string, Property: string[]): void {
...
export function defineProps(propsObject: Record<string, string[]>): void {
...
export function makeStyles(stylesObject: Record<string, string>): void {
