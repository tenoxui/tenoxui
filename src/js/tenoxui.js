...
function makeValue(type, property, customValue) {
  // Check if 'type' and 'property' are strings
  if (typeof type !== "string" || typeof property !== "string") {
    console.warn(
      "Invalid arguments for makeValue. Please provide strings for type and property."
    );
    return "";
  }

  // Register the new type and property
  ...
  // Add the custom value to the property
  property[type].push(customValue);
